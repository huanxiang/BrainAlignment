 ...
 *
 *=========================================================================*/
#ifndef __itkDualResampleImageFilter_h
#define __itkDualResampleImageFilter_h
...
namespace itk
{
/** \class DualResampleImageFilter
 * \brief Resample an image via a coordinate transform
 *
 * DualResampleImageFilter resamples an existing image through some coordinate
 ...
 * \wikiexample{ImageProcessing/DualResampleImageFilter,Resample (stretch or compress) an image}
 * \endwiki
 */
...
public:
  ...
  typedef DualResampleImageFilter                             Self;
  ...
  itkTypeMacro(DualResampleImageFilter, ImageToImageFilter);
  ...
  itkSetConstObjectMacro(Transform2, TransformType);
  ...
  /** DualResampleImageFilter produces an image which is a different size
  ...
  /** DualResampleImageFilter needs a different input requested region than
   * the output requested region.  As such, DualResampleImageFilter needs
...
protected:
  ...
  /** DualResampleImageFilter can be implemented as a multithreaded filter.
...
private:
  DualResampleImageFilter(const Self &); //purposely not implemented
  void operator=(const Self &);      //purposely not implemented

  SizeType                m_Size;         // Size of the output image
  TransformPointerType    m_Transform;    // Transform
	TransformPointerType    m_Transform2;    // Transform2
...
#include "itkDualResampleImageFilter.cxx"
#endif
